  ...
  const Login = async () => {
    try {
      const res = await axios.post(
        "https://stocktrackpro-2.onrender.com/api/user/login",
        userData
      );
...
const OTP = ({ userData, otp, close, setOTP }) => {
  ...
  const sendOTP = async () => {
    try {
      const res = await axios.post("https://stocktrackpro-2.onrender.com/api/user/OTPVerify", {
  ...
  const registerUser = async () => {
    try {
      const res = await axios.post(
        "https://stocktrackpro-2.onrender.com/api/user/register",
        userData
      );
      if (res.status === 200) {
        const userData = {
