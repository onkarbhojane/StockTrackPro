...
const AllStocks = () => {
  ...
  useEffect(()=>{
    (async ()=>{
      try{
        const res=await axios.get('https://ai-script-writter-website.onrender.com/service/stockname');
      ...
      try{
        ...
        symbols.map(async(symbol,index)=>{
          arr.push(await axios.get(
            `https://ai-script-writter-website.onrender.com/service/scrapweb/info?symbol=${symbol}`
          ));
        })
        arr.map((res,index)=>{
